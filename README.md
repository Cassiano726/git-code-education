...
Criando link com repositórtio remoto apontando para o Bare
...
cd aulagit.git                                              - Acessar a paste que possui o diretório hooks  
ls                                                          - Visualizar   
...
CHMOD +x post-receive                                       - Atribuindo a permissão de gancho
...
git push local master                                      - subindo as alterações e linkando com o gancho (local) 